...
public class TweetClassifier {
    ...
    public static void main(String[] args) {
        ...
        TweetPreprocess spamPreprocess = new TweetPreprocess();
        ...
        try {
            PrintWriter pw = new PrintWriter(new FileOutputStream("dataset3.arff", true));
            ...
            Logger.getLogger(TweetClassifier.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
